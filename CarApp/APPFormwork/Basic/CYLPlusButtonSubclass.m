...
- (void)layoutSubviews {
    ...
    CGFloat const centerOfTitleLabel = imageViewEdgeHeight  + verticalMargin * 2 + labelLineHeight * 0.5-11.3;

    //imageView position 位置
//    self.imageView.bounds = CGRectMake(0, 0, imageViewEdgeWidth, imageViewEdgeHeight);
    self.imageView.center = CGPointMake(centerOfView, centerOfImageView);
    self.imageView.top = 14;
...
+ (id)plusButton {
    ...
    UIImage *normalButtonImage = [UIImage imageNamed:@"buticon110"];
    UIImage *hlightButtonImage = [UIImage imageNamed:@"buticon111"];
    ...
    [button setTitle:@"配件商城" forState:UIControlStateNormal];
    UIImage *normalButtonBackImage = createImageWithColor(KTextWhiteColor);
...
+ (UIViewController *)plusChildViewController {
    UIViewController *plusChildNavigationController = [[RJNavigationController alloc]
                                                   initWithRootViewController:[CarViewController new]];
