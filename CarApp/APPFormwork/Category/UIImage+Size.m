...
-(NSData *)compressWithMaxLength:(NSUInteger)maxLength{
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        //NSLog(@"Compression = %.1f", compression); //NSLog(@"In compressing quality loop, image size = %ld KB", data.length / 1024);
    ...
    UIImage *resultImage = [UIImage imageWithData:data]; // Compress by size
